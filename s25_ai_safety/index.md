...
1. Amodei, D., Olah, C., Steinhardt, J., et al. (2016). Concrete Problems in AI Safety.
...
4. Wei, J., et al. (2023). Jailbroken: How Does LLM Safety Training Fail? *NeurIPS 2023*.
5. Perez, E., et al. (2022). Discovering Language Model Behaviors with Model-Written Evaluations.
6. Hendrycks, D., Mazeika, M., & Woodside, T. (2023). An Overview of Catastrophic AI Risks.
7. Ngo, R., Chan, L., & Mindermann, S. (2022). The Alignment Problem from a Deep Learning Perspective. *ICLR 2024*.
